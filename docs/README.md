...
| [`REVIEW_SYSTEM.md`](./REVIEW_SYSTEM.md) | 🔴 **제품의 급소** — FSRS · 두 층의 복습 · ~~회상 질문 5종~~(결정 #28) · 오늘의 복습 · 알림 · 4등급 라벨 | ✅ 2026-09-09 |
| [`AI_SYSTEM.md`](./AI_SYSTEM.md) | 🚫 **폐기(결정 #28 · 2026-09-21)** — AI 를 붙이지 않는다. ~~분석 · 질문 생성 · 프록시 무저장 · 콘텐츠 유형 5종 · 비용 방어 · 고지 문안~~ · 기록으로 남는다 | 🚫 2026-09-21 |
| [`PRACTICE_SYSTEM.md`](./PRACTICE_SYSTEM.md) | 실천 생성(사용자 확정) · 체크 · 연속일 · **지식과의 분리**. 🔴 [넘어가기]가 남는 자리(§1.1) · `active` 는 스위치다(§2.1) | ✅ 2026-09-10 |
| [`MONETIZATION_SYSTEM.md`](./MONETIZATION_SYSTEM.md) | 🔄 **광고 + 광고 제거**(결정 #29 · 2026-09-21 · ~~구독 단독(광고 없음) · 티어~~) · 넣기 전에 할 일 · 법적 의무 | 🔄 2026-09-21 |
...
**2026-09-21 기준. Phase 0·1·2·6·9 완료 · Phase 10 은 코드까지(비공개 테스트 동안 광고 끔) · Phase 3·4·5 는 실기기·사용자 판정만 남았다 · ~~Phase 8 AI~~ 폐기(결정 #28).**
🔴 남은 것은 사용자 계정 · 배포가 열려야 한다(Phase 7 common_server · Phase 10 상품 · 가격 · Phase 11 처리방침 게시 · 등록정보).
비공개 트랙에는 vc11 `0.1.11` 이 있다(`BUILD.md` §6.10).
아래 표가 착수 순서의 기준이 된다.
...
| 복습 v1 — FSRS · 기본 복습 · 오늘의 복습 · 홈 | ✅ | Phase 3(2026-09-09). 🔴 AI 없이 성립하는지는 **사용자 판정이 남았다**(PLAN Phase 3 ★) · 🔄 결정 #28 로 AI 없는 복습이 제품 그 자체가 됐다 |
...
| ~~Anthropic API 키~~ | 🚫 | 결정 #28 — 필요 없다 |
| 스토어 상품 `remove_ads`(비소비성) | ❌ | Phase 10 · 결정 #31 · 🔄 ~~RevenueCat + 월/연~~ · 출시 때 광고를 켜는 커밋 전에 |
| AdMob 앱 · 광고 단위 | ✅ 2026-09-21 | 앱 Re:Read(스토어 미연결) · 배너 · 전면 · GDPR 메시지 임시저장 |
...
| 처리방침 · 약관 게시 (EN · KO) | 🔨 | 처리방침 문안 v1.2 ✅(광고 포함) · 🔴 공개 페이지는 v1.0 · 게시는 사용자 배포 · 약관 ❌ |
