...
🟢 **2026-09-12 기준 8/11.** 남은 셋과 막는 것은 §9.
...
| 4 | 앱 설정 나머지 셋 | 🔨 **세션 진행 중** | 🟢 **8/11 완료.** 남은 것은 콘텐츠 등급(IARC)·앱 카테고리와 연락처·스토어 등록정보다.<br>⚠ ~~폼 저장이 곧 게시~~ 는 **앱 콘텐츠 항목에는 적용되지 않았다** — 저장은 게시 개요에 모이고 `검토를 위해 제출` 이 따로다(§8.3) |
