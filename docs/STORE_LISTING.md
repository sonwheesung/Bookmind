...
| 항목 | 값 | 상태 |
|---|---|---|
| 개인정보처리방침 | `https://vivace-games.com/reread/privacy` | 🔨 **문안 완성 · 미게시** — 정본 [`legal/PRIVACY.en.md`](./legal/PRIVACY.en.md)(영문) · [`.ko.md`](./legal/PRIVACY.ko.md) |
...
| 2 | 처리방침 **게시** | 🔴 **사용자** | 🟢 문안은 끝났다(§8). 남은 것은 배구 서버 저장소 수정과 Vercel 배포다 |
