...
| 헤더 로고 | ✅ 2026-09-14 — 홈만 `brand` 32/40 · 나머지 22/30(`DESIGN_REVIEW.md` §3) |
...
| `Header` | 화면 제목 · 뒤로 | 오른쪽 자리(`right`)는 조용한 글자 링크만. 버튼을 두지 않는다 · 🔴 `variant="brand"`(32/40)는 **홈의 앱 이름에만** 쓴다(`DESIGN_REVIEW.md` §3 · 2026-09-14) |
